...
const cardBlock = document.querySelector('.our-friends-cards')
...
cardBlock.addEventListener('click', togglePopap)
...
function getRandomBundleOfArrays(length){
let arrayOfArrays = []
  for (let i = 0; i<length; i++){
  arrayOfArrays.push(getRandomSet(0, 7, 8))
}
return arrayOfArrays;
}

console.log(getRandomBundleOfArrays(6))

const upPage = document.querySelector('#nextUpPage');
const num = document.querySelector('#num');
let count =  0;
console.log(num.textContent)


const cardsBlock = document.querySelector('.our-friends-cards')

console.log(Array.from(cardsBlock.children))
...
let arrayofCards = Array.from(cardsBlock.children)
let id = arrayofCards.map((e)=> {
  return Number(e.id);
})
console.log(id)
